...
def main(args: argparse.Namespace):
    ...
    if args.exec_type == 1:
        num_model_per_group = args.num_models // args.num_groups
    else:
        num_model_per_group = args.num_models
    ...
    # TODO: hard-coded
    model_ids = [i % args.num_models for i in range(args.batch_size)]
    ...
    def run_to_completion(profile: bool = False):
        ...
        llm.generate(prompt_token_ids=dummy_prompt_token_ids,
                     sampling_params=sampling_params, model_ids=model_ids,
                     use_tqdm=False)
