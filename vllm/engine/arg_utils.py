...
class EngineArgs:
    ...
    def add_cli_args(
        ...
        parser.add_argument('--num-models',
                            type=int,
                            default=EngineArgs.num_models,
                            help='number of models')
        parser.add_argument('--num-groups',
                            type=int,
                            default=EngineArgs.num_groups,
                            help='number of groups')
        parser.add_argument('--num-model-per-group',
                            type=int,
                            default=EngineArgs.num_models // EngineArgs.num_groups,
                            help='number of models per group')
        parser.add_argument('--max-r',
                            type=int,
                            default=EngineArgs.max_r,
                            help='maximum rank of lora weight')
        parser.add_argument('--gpu-capacity',
                            type=int,
    ...
    def create_engine_configs(
        self,
    ) -> Tuple[ModelConfig, CacheConfig, ParallelConfig, SchedulerConfig, LoRaConfig]:
