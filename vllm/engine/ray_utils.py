...
def initialize_cluster(
...
) -> Tuple[str, Optional[List["PlacementGroup"]]]:
    ...
    for i in range(parallel_config.pipeline_parallel_size):
        ...
        if parallel_config.tensor_parallel_size > num_gpus_in_cluster:
            raise ValueError(
                "The number of required GPUs exceeds the total number of "
        ...
        placement_groups.append(current_placement_group)

    return None, placement_groups
