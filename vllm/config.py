...
class SchedulerConfig:
    ...
    Args:
        ...
        max_model_len: Maximum length of a sequence (including prompt
            and generated text).
        policy: Name of scheduler policy.
    """

    def __init__(self, max_num_batched_tokens: int, max_num_seqs: int,
                 max_model_len: int, policy: str) -> None:
...
class LoRaConfig:
    ...
    Args:
        max_r: Maximum rank of lora weights.
        num_models: Number of lora weights.
        gpu_capacity: Maximum number of lora weights.
    """

    def __init__(self, max_r: int, num_models: int, gpu_capacity: int) -> None:
        self.max_r = max_r
