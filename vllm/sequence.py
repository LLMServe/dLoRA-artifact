...
class SequenceStatus(enum.Enum):
    ...
    WAITING = enum.auto()
    RUNNING = enum.auto() # The sequence is in an on-the-fly batch
    SWAPPED = enum.auto()
    READY = enum.auto() # The sequence is ready to be launched
...
class SequenceGroup:
    ...
    Args:
        ...
        model_id: The targeted ID of the request.
    """
...
class SequenceGroupMetadata:
    ...
    Args:
        ...
        block_tables: The block tables. (Seq id -> list of physical block
            numbers)
        model_id: The targeted model ID of the request.
    """
