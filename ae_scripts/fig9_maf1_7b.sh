...
if [ $exec_type -eq 1 ]; then
    ...
    python benchmarks/benchmark_serving.py --backend vllm --tokenizer hf-internal-testing/llama-tokenizer  --dataset ~/ShareGPT_V3_unfiltered_cleaned_split.json --request-rate 10 --num-models 128 --num-prompts 1000 --trace_name azure_v1 --trace_path ~/maf1/ --start_time 0.0.0 --end_time 0.2.0 --interval 60 --host $host --output $output --exec_type $exec_type --output_style 4

    python benchmarks/benchmark_serving.py --backend vllm --tokenizer hf-internal-testing/llama-tokenizer  --dataset ~/ShareGPT_V3_unfiltered_cleaned_split.json --request-rate 12 --num-models 128 --num-prompts 1200 --trace_name azure_v1 --trace_path ~/maf1/ --start_time 0.0.0 --end_time 0.2.0 --interval 60 --host $host --output $output --exec_type $exec_type --output_style 4
